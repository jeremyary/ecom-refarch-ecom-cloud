...
function cloudRoute() {
    ...
    cloud.post('/customers/:userId/orders', function(req, res) {
    ...
    cloud.put('/customers/:userId/orders', function(req, res) {
    ...
    cloud.post('/customers/:userId/orders/:orderId/orderItems', function(req, res) {
